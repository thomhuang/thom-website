...
import { updateDevicePlatform, updateLastLocation } from "../Reducers/UserContextSlice";
...
export function ResizeListener() {
    ...
    useEffect(() => {
        const handleResize = () => {
            ...
            else if (isCurrentlyMobile && location.pathname !== ToPage(PAGES.MobileHome)) {
    ...
    }, [dispatch, location.pathname, nav, userContext.isMobile, userContext.lastLocation]);
}
