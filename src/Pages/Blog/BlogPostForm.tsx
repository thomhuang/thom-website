          ...
          <form className={styles.form} onSubmit={savePost}>
            ...
            <div className={styles.field}>
              ...
              <p className={styles.hint}>
                {isImageUploading
                  ? 'Uploading image...'
                  : 'Markdown supported: headings, emphasis, links, lists, code. Headings get anchor ids, so [text](#heading-name) jumps to one. Paste an image to upload it; put images on one line to sit them side by side, with alt text as the caption. Add {width=50%} after an image to resize it.'}
              </p>
            </div>
